...
- Supported splits: random split, scaffold split, and random-scaffold split.
- Supported evaluation: ROC_AUC.
...
To reproduce or finetune MolCLR, MoMu, and GraphMVP using their trained checkpoints, you can download the checkpoints from:  
...
You will need to rename and place the checkpoints at the following path.
...
You can run the Bash scripts under `scripts/dp/`:
